...
describe('Student e2e test', () => {
  ...
  describe('new Student page', () => {
    ...
    it('should create an instance of Student', () => {
      cy.get(`[data-cy="studentId"]`).type('31041').should('have.value', '31041');

      cy.get(`[data-cy="name"]`).type('array Grenadines').should('have.value', 'array Grenadines');

      cy.get(`[data-cy="age"]`).type('34182').should('have.value', '34182');

      cy.get(`[data-cy="classNam"]`).type('wireless').should('have.value', 'wireless');

      cy.get(`[data-cy="address"]`).type('recontextualize e-services').should('have.value', 'recontextualize e-services');
