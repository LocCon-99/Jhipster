...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSENTITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLASSENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLASSENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLASSENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLASSENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLASSENTITY actions', async () => {
      const expectedActions = [
        {
